...
def run_drill():
    ...
    with term.location():
        print(term.home + term.move_xy(0, term.height), end='')
        info_str = "   Drill   "
        print(term.move_right(term.width - (len(info_str))) + term.black_on_white(info_str), end='')
    print(term.cyan(term.center("QUICK TEST")) + term.move_down(1), sep='')
    ...
    print(term.white(term.center("(1)")), end='', flush=True)
